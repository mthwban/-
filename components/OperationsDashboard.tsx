...
import { BarChart, Activity, ShieldCheck, Zap, TrendingUp, PieChart, Layers, Clock } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="flex items-end gap-3 h-64">
                 {[40, 75, 50, 95, 70, 85, 60, 100, 80, 110, 90, 150].map((val, i) => (
                   <div key={i} className="flex-1 group relative">
                      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 px-3 py-1 bg-[#D4AF37] text-black text-[10px] font-black rounded opacity-0 group-hover:opacity-100 transition-all">
                        {val}k
                      </div>
           ...
           <div className="lg:col-span-4 flex flex-col gap-8 reveal">
              <div className="flex-1 p-10 glass-card rounded-[3.5rem] border border-white/5 flex flex-col justify-center items-center text-center">
